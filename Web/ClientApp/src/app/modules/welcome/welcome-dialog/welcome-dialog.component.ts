...
import { selectParticipantById, Participant, ParticipantUpdated, InitRegistration, selectInitRegistration, RegistrationComplete, selectRegistrationComplete, selectIsSuccess} from './../../../core/auth';
...
export class WelcomeDialogComponent implements OnInit {
	...
	ngOnInit() {
		...
		this.store.pipe(select(selectInitRegistration)).subscribe(res => {
				...
				this.firstFormGroup = this._formBuilder.group({
					...
					hasCarer: [this.participant.hasCarer, Validators.required],
	...
	prepareParticipant(): Participant {
		...
		_participant.hasCarer = controls['hasCarer'].value;
