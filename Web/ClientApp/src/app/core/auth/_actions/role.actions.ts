...
export enum RoleActionTypes {
    ...
    RolesListRequested = '[Roles] Roles List Requested',
    RolesListLoaded = '[Roles] Roles List Loaded',
}
...
export class RolesPageLoaded implements Action {
    ...
    constructor(public payload: { roles: Role[], total: number, page: QueryParamsModel }) { }
}
...
export class RolesListRequested implements Action {
    readonly type = RoleActionTypes.RolesListRequested;
    constructor(public payload: {}) { }
}

export class RolesListLoaded implements Action {
    readonly type = RoleActionTypes.RolesListLoaded;
    constructor(public payload: { roles: any, total: number }) { }
}
