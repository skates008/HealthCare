...
namespace Microsoft.EntityFrameworkCore
{
    public static class AddOrUpdateExtension
    {
        ...
        /// <summary>
        ///     Checks dynamically if the entity exists in the databse. If it does, changes the referenced entity to the database
        ...
        ///     keys ids in wich the given values are equal to 0.
        /// </summary>
            ...
            where TEntity : class
        {
            ...
            var expressions = string.Join(" AND ",
