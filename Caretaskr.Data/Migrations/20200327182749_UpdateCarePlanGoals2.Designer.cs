...
namespace Caretaskr.Data.Migrations
{
    ...
    [Migration("20200327182749_UpdateCarePlanGoals2")]
    partial class UpdateCarePlanGoals2
    {
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.CareplanShortTermGoal", b =>
                {
                    ...
                    b.Property<int?>("CareplanFamilyGoalId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CareplanFamilyGoalId1");
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.CareplanFamilyGoal", b =>
                {
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.Careplan", null)
                        .WithMany("FamilyGoals")
                        .HasForeignKey("CareplanId1");
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.CareplanShortTermGoal", b =>
                {
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.CareplanFamilyGoal", null)
                        .WithMany("ShortTermGoals")
                        .HasForeignKey("CareplanFamilyGoalId1");
