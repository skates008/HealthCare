...
namespace Caretaskr.Data.Migrations
{
    ...
    [Migration("20200513090140_appointment_removeteamid")]
    partial class appointment_removeteamid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Caretaskr.Common.ViewModel.BillingDetails", b =>
                {
                    ...
                    b.Property<string>("BillingTermsOfService")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("PatientRecordId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PatientRecordId1")
                        .IsUnique()
                        .HasFilter("[PatientRecordId1] IS NOT NULL");
            ...
            modelBuilder.Entity("Caretaskr.Common.ViewModel.BillingRun", b =>
                {
                    ...
                    b.Property<string>("BillingcConfSnapshot")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Caretaskr.Common.ViewModel.BillingSettings", b =>
                {
                    ...
                    b.HasIndex("ProviderId1")
                        .IsUnique()
                        .HasFilter("[ProviderId1] IS NOT NULL");
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.Provider", b =>
                {
                    ...
                    b.OwnsOne("CareTaskr.Domain.Entities.AddressDetails", "RegisteredCompany", b1 =>
                        {
                            b1.Property<int>("ProviderId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
            ...
            modelBuilder.Entity("Caretaskr.Common.ViewModel.BillingDetails", b =>
                {
                    b.HasOne("CareTaskr.Domain.Entities.Address", "BillingAddress")
                        .WithMany()
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.PatientRecord", null)
                        .WithOne("BillingDetails")
                        .HasForeignKey("Caretaskr.Common.ViewModel.BillingDetails", "PatientRecordId1");
            ...
            modelBuilder.Entity("Caretaskr.Common.ViewModel.BillingSettings", b =>
                {
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.Provider", null)
                        ...
                        .HasForeignKey("Caretaskr.Common.ViewModel.BillingSettings", "ProviderId1");
                });
            ...
            modelBuilder.Entity("Caretaskr.Common.ViewModel.InvoiceItem", b =>
                {
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.TimeEntryBillableItem", "TimeEntryBillableItem")
                        .WithMany()
                        .HasForeignKey("TimeEntryBillableItemId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
