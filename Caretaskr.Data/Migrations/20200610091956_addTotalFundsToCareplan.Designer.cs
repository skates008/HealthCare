...
namespace Caretaskr.Data.Migrations
{
    ...
    [Migration("20200610091956_addTotalFundsToCareplan")]
    partial class addTotalFundsToCareplan
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.AppointmentRecurrenceGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("FirstInstance")
                        .HasColumnType("datetime2");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit");

                    b.Property<DateTime>("LastInstance")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("AppointmentRecurrenceGroup");
                });

            modelBuilder.Entity("CareTaskr.Domain.Entities.AppointmentRecurrenceInstance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppointmentRecurrenceInstance");
                });
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.Assesment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.ServiceAgreement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.Note", "ExternalNote")
                        .WithMany()
                        .HasForeignKey("ExternalNoteId");

                    b.HasOne("CareTaskr.Domain.Entities.Note", "InternalNote")
                        .WithMany()
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.AppointmentRecurrenceGroup", "RecurrenceGroup")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.AppointmentRecurrenceInstance", b =>
                {
                    b.HasOne("CareTaskr.Domain.Entities.Appointment", "Appointment")
                        .WithOne("RecurrenceInstance")
                        .HasForeignKey("CareTaskr.Domain.Entities.AppointmentRecurrenceInstance", "AppointmentId");
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.Patient", b =>
                {
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.Address", "SchoolAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("CareTaskr.Domain.Entities.PatientRecordFile", b =>
                {
                    b.HasOne("CareTaskr.Domain.Entities.Assesment", "Assesment")
                        .WithMany("Files")
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.FileUpload", "FileUpload")
                        .WithOne("PatientRecordFile")
                        .HasForeignKey("CareTaskr.Domain.Entities.PatientRecordFile", "FileUploadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.Note", null)
                        .WithMany("Files")
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.ServiceAgreement", "ServiceAgreement")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("Caretaskr.Common.ViewModel.Invoice", b =>
                {
                    ...
                    b.HasOne("CareTaskr.Domain.Entities.PatientRecordFile", "File")
                        .WithMany()
